...
. Создать запрос для вывода тех значений, которые содержат в себе палиндромы,
и самые длинные выражения, представляющие из себя палиндром.
*/
CREATE TABLE tab13(TEXT VARCHAR2(50)CONSTRAINT zad13_pk PRIMARY KEY);

INSERT INTO tab13 VALUES('Êðîêîäèë');
INSERT INTO tab13 VALUES('Êîëîêîë');
INSERT INTO tab13 VALUES('Êðîêîäèë è êîëîêîë');
INSERT INTO tab13 VALUES('Ñòàíîê');
INSERT INTO tab13 VALUES('        Êðîêîäèë          ');
